...
- New flaky tests: Tests that were never flaky previously in the default branch. If the default branch is not properly set, this could lead to a wrong number of detected new flaky tests.

#### How to fix the default branch
If you have admin access, you can update it from the [Repository Settings Page][9].
