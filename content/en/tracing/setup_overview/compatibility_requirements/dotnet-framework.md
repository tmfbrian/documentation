...
<div class="alert alert-info">
  <div class="alert-info"><b>Note:</b> If you use automatic instrumentation only, the .NET Framework Version to take into account is the version installed on the application server.<br/>
